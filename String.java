...
/**
 * final关键字表明了String是不可变的类
 * 意思就是不想让你继承，好处是String对象可以共享
 *
 * 实现Serializable接口表示能够对String对象进行序列化操作
 *
 * 实现Comparable接口为了能够比较字符串之间的大小
 *
 * 实现CharSequence接口是为了支持字符序列抽象出来的一些通用的操作
 *
*/
